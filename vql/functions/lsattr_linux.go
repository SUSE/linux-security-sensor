...
func (self LsattrFunction) Call(ctx context.Context,
	scope vfilter.Scope,
	...
	return Lsattr(lsattr)
}

func (self LsattrFunction) Info(scope vfilter.Scope, type_map *vfilter.TypeMap) *vfilter.FunctionInfo {
	return &vfilter.FunctionInfo{
		Name:    "lsattr",
		Doc:     "Queries the attributes for a file.",
		ArgType: type_map.AddType(scope, &LsattrArgs{}),
	}
}

func init() {
	vql_subsystem.RegisterFunction(&LsattrFunction{})
}
